...
\hypertarget{md__library_2_package_cache_2com_8unity_8timeline_0d1_87_86_2_documentation_0i_2wf__char__anim}{}\label{md__library_2_package_cache_2com_8unity_8timeline_0d1_87_86_2_documentation_0i_2wf__char__anim}\index{Animating a humanoid@{Animating a humanoid}}
\label{md__library_2_package_cache_2com_8unity_8timeline_0d1_87_86_2_documentation_0i_2wf__char__anim_autotoc_md1266}%
\Hypertarget{md__library_2_package_cache_2com_8unity_8timeline_0d1_87_86_2_documentation_0i_2wf__char__anim_autotoc_md1266}%
...
To position, resize, or trim your Animation clip in the Clips view, select {\bfseries{Mix mode}} as the Clip Edit mode. There are \doxysectlink{md__library_2_package_cache_2com_8unity_8timeline_0d1_87_86_2_documentation_0i_2clp__about}{three different Clip Edit modes}{0} that change the editing behaviour of the \doxylink{namespace_timeline}{Timeline} window. When the \doxylink{namespace_timeline}{Timeline} window is in {\bfseries{Mix mode}}, you can drag and trim clips to create blends.
...
{\itshape The humanoid jumps between the first Animation clip, which ends at frame 29 (red arrow and box), and the second Animation clip, which starts at frame 30 (ghost with green arrow and box)}\hypertarget{md__library_2_package_cache_2com_8unity_8timeline_0d1_87_86_2_documentation_0i_2wf__char__anim_autotoc_md1267}{}\doxysection{\texorpdfstring{Matching clips}{Matching clips}}\label{md__library_2_package_cache_2com_8unity_8timeline_0d1_87_86_2_documentation_0i_2wf__char__anim_autotoc_md1267}
To fix the animation jump between clips, match the offset of each Animation clip. The \doxylink{namespace_timeline}{Timeline} window provides \doxysectlink{md__library_2_package_cache_2com_8unity_8timeline_0d1_87_86_2_documentation_0i_2clp__match}{different methods for matching offsets}{0}. In this example, \doxylink{namespace_timeline}{Timeline} matches the second Animation clip with the previous clip. To do this, select the Run\+\_\+\+Left clip, right-\/click and select {\bfseries{Match Offsets to Previous Clip}}.
...
As the Idle clip transitions to the Run\+\_\+\+Left clip, the blend removes the obvious jump between poses. The transition between most body parts appears natural, however in this example, the blend between the different positions of the foot results in an unnatural foot slide.\hypertarget{md__library_2_package_cache_2com_8unity_8timeline_0d1_87_86_2_documentation_0i_2wf__char__anim_autotoc_md1269}{}\doxysection{\texorpdfstring{Reducing foot slide}{Reducing foot slide}}\label{md__library_2_package_cache_2com_8unity_8timeline_0d1_87_86_2_documentation_0i_2wf__char__anim_autotoc_md1269}
